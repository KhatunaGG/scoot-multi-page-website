      ...
      <section className="container w-full  flex flex-col items-center justify-center
        ...
        <article className="faq-wrapper px-[32px] md:px-[5.07%] lg:px-[11.45%]">
          ...
          <div className="wrapper-inner flex flex-col items-center justify-center gap-[48px]">
            ...
            <div className="work flex flex-col items-center justify-center gap-8 lg:flex-row lg:justify-between lg:items-start">
              <h3 className="text-2xl leading-[1.16] tracking-[-1.07px] text-[#495567] font-bold lg:whitespace-nowrap">How it works</h3>

              <div className="box flex flex-col gap-6">
                <div className="q1 w-full bg-[#F2F5F9] p-8 flex flex-col gap-6">
                  <div className="flex flex-row items-center justify-between">
                    <h4 className="text-lg leading-[1.33] tracking-[-0.8px] text-[#495567] font-bold">How do I download the app?</h4>
                    <img className="w-4 h-2" src="/assets/icons/chevron.svg" alt="" />
                  </div>
                  <div className="font-thin text-[15px] leading-[1.66] ">To download the Scoot app, you can search “Scoot” in both the App and Google Play stores. An even simpler way to do it would be to click the relevant link at the bottom of this page and you’ll be re-directed to the correct page.</div>
                </div>
                ...
                <div className="q1 w-full bg-[#F2F5F9] p-8 flex flex-col gap-6">
                  ...
                  <div className="hidden font-thin text-[15px] leading-[1.66] ">To download the Scoot app, you can search “Scoot” in both the App and Google Play stores. An even simpler way to do it would be to click the relevant link at the bottom of this page and you’ll be re-directed to the correct page.</div>
                </div>
            ...
            <div className="driving flex flex-col items-center justify-center gap-8 lg:flex-row lg:justify-between lg:items-start">
              <h3 className="text-2xl leading-[1.16] tracking-[-1.07px] text-[#495567] font-bold lg:whitespace-nowrap">Safe driving</h3>
              ...
              <div className="box flex flex-col gap-6">
                <div className="q1 w-full bg-[#F2F5F9] p-8 flex flex-col gap-6">
                  ...
                  <div className="font-thin text-[15px] leading-[1.66] ">Yes, please do! All cities have different laws. But we strongly strongly strongly recommend always wearing a helmet regardless of the local laws. We like you and we want you to be as safe as possible while Scooting.</div>
                </div>
