...
const pages = ['about', 'location', 'careers']
    ...
    return (
        <div className='w-fill '>
            <div className="header  ">
                <div className='header-container px-[11.45%] flex flex-row py-[22px] md:px-[39px]'>
                    <div className='logo-container flex w-full justify-center items-center md:gap-[58.18px] md:justify-start  relative'>
                        {screenWidth < 376 && (
                            <svg className='absolute top-[50%] translate-y-[-25%] left-0' width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="burger">
                        ...
                        <div className="hidden pages md:flex flex-row items-center gap-[32px]">
                            {pages.map((item, i) => (
                                <Link to={`/${item}`}>
                                    <div key={i} className='pageItem capitalize'>{item}</div>
                                </Link>
                            ))}
                        </div>
                    </div>
                ...
                <div className='div absolute bottom-[-438px]  left-0  w-full bg-[#333A44] h-[438px] pt-[64px] px-[133px] md:h-[96px] md:px-8 md:py-8 md:bottom-[-95px] lg:px-[165px]'>
                    <div className='flex flex-col gap-[85px] items-center justify-center text-center md:flex-row md:justify-between'>
                        <div className='box-2 flex flex-col items-center justify-center gap-[41.44px]  md:justify-between md:flex-row'>
                            ...
                            <div className='flex flex-col gap-4 text-[#939CAA] font-bold text-[15px] leading-[1.66] md:flex-row'>
                                <a href="">About</a>
                                <a href="">Location</a>
                                <a href="">Careers</a>
                            </div>
...
//             <div className="header  ">
//                 <div className='header-container mx-auto   bg-green-400   w-[82.93%] md:w-[89.84%] lg:w-[77.70%] '>
...
//             </div>
//             <Outlet />
//             {/* <footer className="footer w-full bg-gray-400">
//                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur accusamus explicabo cupiditate sunt ipsam dolorem quidem, harum amet exercitationem fugit.</p>
//             </footer> */}
