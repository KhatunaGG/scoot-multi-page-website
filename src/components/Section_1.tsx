...
const Section_1 = () => {
  ...
  return (
    <div className="box-1 flex flex-col items-center justify-center text-center gap-[45px] md:flex md:relative lg:flex-row lg:items-baseline  relative">
      <div className="hidden w-[14px] h-[573px] bg-[#D8D8D8] absolute top-[-146px] left-0 -z-20 ml-[42px] md:flex lg:hidden "></div>
      <div className="lg:h-[14px] w-[973px] bg-[#D8D8D8] absolute -z-20 top-[40px] left-[-220px]"></div>
